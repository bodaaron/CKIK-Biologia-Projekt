...
<<<<<<< HEAD
          ...
          successMessage.value = 'Sikeres adatmódosítás! Az oldal frissül...'
...
<<<<<<< HEAD
  ...
  successMessage.value = 'Felelet sikeresen kiosztva az osztálynak'
  setTimeout(() => window.location.reload(), 3000)
...
<<<<<<< HEAD
  ...
  if (isValid) {
    await diakFelelet(diakTesztData.value, {
      onSuccess() {
        successMessage.value = 'Felelet sikeresen kiosztva!'
        setTimeout(() => window.location.reload(), 3000)
        dialog4.value = false
        dialog2.value = false
      },
...
const handleTorlesIgen = async () => {
  ...
  successMessage.value = 'A felhasználó törölve lett'
  setTimeout(() => window.location.reload(), 3000)
  dialog5.value = false
  dialog2.value = false
}
...
const handleJogosultsagIgen = async () => {
  ...
  successMessage.value = 'A felhasználó mostantól rendelkezik tanári jogosultságokkal'
  setTimeout(() => window.location.reload(), 3000)
  dialog6.value = false
  dialog2.value = false
}
...
const handleJogosultsagElvetIgen = async () => {
  ...
  successMessage.value = 'A felhasználó mostantól nem rendelkezik tanári jogosultságokkal'
  setTimeout(() => window.location.reload(), 3000)
  dialog9.value = false
  dialog2.value = false
}
...
const handleKijavitasDB = async () => {
  ...
  successMessage.value = 'A kipipált válaszok ellettek fogadva'
  setTimeout(() => window.location.reload(), 3000)
  dialog2.value = false
  dialog7.value = false
  dialog8.value = false
